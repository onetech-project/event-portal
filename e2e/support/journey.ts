...
export class GuestJourney {
   ...
   * before spec 019 the frame printed them and this method failed naming them.
  ...
  async expectQrisFrameContents(): Promise<void> {
    ...
    // only holds AFTER spec 019 (the title used to be a styled div), and a
