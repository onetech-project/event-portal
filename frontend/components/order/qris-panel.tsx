 ...
 *
 * The frame carries what the design draws and nothing else. Spec 019 removed
 ...
 * rather than saying "check the amount". Spec 019 supersedes spec 012's
        ...
        <div className="@container w-full">
          ...
          >
            ...
            {/* The batik ground, lifted from the design as one layer so its
                ...
                footer band was repaired by hand when spec 019 removed the text
