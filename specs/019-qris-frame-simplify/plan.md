...
**Branch**: `019-qris-frame-simplify` | **Date**: 2026-08-18 | **Spec**: [spec.md](./spec.md)

**Input**: Feature specification from `/specs/019-qris-frame-simplify/spec.md`
...
- `specs/012-manjo-payment-gateway/research.md` — the frame-identity decision (~L290) and
  the verification table row (~L332) annotated as superseded by spec 019.
